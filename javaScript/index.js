...
// const publicKey = '49b7bb3a81a0b9cde044001bbb237fa7'; 
// const privateKey = '1802960afbf62'; 
// const ts = new Date().getTime();
// const hashInput = `${ts}${privateKey}${publicKey}`;

// const md5Hash =CryptoJS.MD5(hashInput).toString();

// md5Hash: 97e0d89189b010ac7aec52da4e3a4cc2
     ...
     await fetch(`https://gateway.marvel.com/v1/public/characters?nameStartsWith=${textSearched}&apikey=49b7bb3a81a0b9cde044001bbb237fa7&hash=97e0d89189b010ac7aec52da4e3a4cc2&ts=1696402137010`)
